  ...
  return <ThemeProvider theme={theme}>
    ...
    <Box sx={styles.flexContainer} width='80%' margin='auto'>
      <Box sx={styles.flexContainer}>
        <Typography variant='h1' fontWeight='bold'>支持我們</Typography>
      ...
      <Grid container gap='3rem'>
        <Grid item container gap='1rem'>
          <Typography variant='h1' fontWeight='bold'>主辦單位</Typography>
          <Typography variant='body1'>
            <Typography variant='h3' fontWeight='bold'>SITCON 學生計算機年會籌備團隊</Typography>
        ...
        <Grid item container gap='1rem'>
          <Typography variant='h1' fontWeight='bold'>共同主辦</Typography>
          <Typography variant='body1'>
        ...
        <Grid item container gap='1rem'>
          <Typography variant='h1' fontWeight='bold'>協辦單位</Typography>
          <Typography variant='body1'>
        ...
        <Grid item container gap='1rem'>
          <Typography variant='h1' fontWeight='bold'>深耕級</Typography>
          <Typography variant='body1'>
            <Image src={`/2024/images/sponsor/.svg`} width={50} height={50} />
          </Typography>
        </Grid>
        <Grid item container gap='1rem'>
          <Typography variant='h1' fontWeight='bold'>前瞻級</Typography>
          <Typography variant='body1'>
            <Image src={`/2024/images/sponsor/.svg`} width={50} height={50} />
          </Typography>
        </Grid>
        <Grid item container gap='1rem'>
          <Typography variant='h1' fontWeight='bold'>新芽級</Typography>
          <Typography variant='body1'>
            <Image src={`/2024/images/sponsor/.svg`} width={50} height={50} />
          </Typography>
        </Grid>
