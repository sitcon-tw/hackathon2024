      ...
      <main id="root">
        <Box
          style={{
            padding: '10px 0',
            position: 'relative',
            backgroundImage: 'url("/2024/images/main.svg")',
            backgroundSize: '120%',
        ...
        >
          <Box style={{ position: 'absolute', top: '25vh', padding: '0 10vw' }}>
            <Typography variant="h5" fontWeight="bold">
              2024.07.06 (六) - 2024.07.07 (日)
            </Typography>
            <Typography variant="h5" fontWeight="bold" marginTop="25px">
              臺北市政府公務人員訓練處
            </Typography>
          </Box>
        ...
        >
          ...
          <Typography marginTop="65px" variant="body1" fontWeight="500">
            ...
            <br />
            <br />
            本屆黑客松主題為 __init__，參考自 Python 語言中初始化物件的方法，我們期待 SITCON
            Hackathon 與參賽者 一同開創新的旅程，實踐「從零到一」的精神。以 __init__
            的方式啟動我們的未來，跨出屬於我們世代的第一步。
          </Typography>
          <br />
          <br />
          <Typography
            sx={{ bottom: '0', textAlign: 'right', color: '#FFFFFF66', fontFamily: 'Rubik One' }}
          >
            SITCON Hackathon
          </Typography>
        </Box>
        ...
        <Box width="80%" margin="auto">
          <Box marginTop="15vh">
            <Box style={{ position: 'relative' }}>
              ...
              <Typography variant="h1" fontWeight="bold" marginTop="30px">
                Our Vision
              </Typography>
            ...
            <Box marginTop="15vh">
              <Typography variant="h1" fontWeight="bold" style={{ lineHeight: '200%' }}>
                行為準則
              </Typography>
              <Typography variant="h1" fontWeight="bold" style={{ lineHeight: '200%' }}>
                Code of Conduct
            ...
            <Box marginTop="15vh">
              ...
              <Typography variant="body1" marginTop="48px" style={{ lineHeight: '200%' }}>
                ...
                <br />
                <br />
                若你想進一步了解 SITCON Hackathon 籌備與討論的內容，歡迎到 GitLab 上查看 SITCON
                Hackathon 2024 的籌備歷程。
              </Typography>
            </Box>
          </Box>
          ...
          <Grid
            ...
            marginTop="15vh"
          >
            <a href="#" target="_blank" className="btn-color" style={{ padding: '25px 40px' }}>
