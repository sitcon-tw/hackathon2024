    ...
    <ThemeProvider theme={theme}>
      <main id="root">
          ...
          <Box sx={{
            ...
            borderRadius: '40px', border: '1px white solid',
            boxShadow: '0px 0px 10px 5px rgba(255, 255, 255, 0.3)',
            position: 'relative',
            lineHeight: '200%',
            padding: '10vh 8vw',
        }}>
            <Typography variant="h1" fontWeight='bold'>黑客松主題</Typography>
            <Typography marginTop='33px' variant="h1" sx={{ fontFamily: 'Russo One' }} style={{ color: '#73BB3A' }}>_ _ INIT_ _</Typography>
            <Typography marginTop='65px' variant="body1" fontWeight='500'>
              ...
              <br />
              <br />
            <Typography sx={{ bottom: '0', textAlign: 'right', color: '#FFFFFF66', fontFamily: 'Rubik One' }}>SITCON Hackathon</Typography>
          </Box>

          <Box width='80%' margin='auto'>
            <Box marginTop='15vh'>
              <Box style={{ position: 'relative' }}>
                <Typography variant="h1" fontWeight='bold'>活動願景</Typography>
                <Typography variant="h1" fontWeight='bold' marginTop='30px'>Our Vision</Typography>
              ...
              <Box marginTop='15vh'>
                <Typography variant="h1" fontWeight='bold' style={{ lineHeight: '200%' }}>行為準則</Typography>
                <Typography variant="h1" fontWeight='bold' style={{ lineHeight: '200%' }}>Code of Conduct</Typography>
              ...
              <Box marginTop='15vh'>
                <Typography variant="h1" fontWeight='bold' style={{ lineHeight: '200%' }}>參與討論</Typography>
                <Typography variant="h1" fontWeight='bold' style={{ lineHeight: '200%' }}>Join the community</Typography>
            ...
            <Grid width='90%' gap='5vw' direction='row' container justifyContent='flex-end' marginTop='15vh'>
