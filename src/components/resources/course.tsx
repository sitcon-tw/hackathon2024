...
const data = [
    { name: '零時小學校', url: 'https://g0v.hackmd.io/@jothon/Sch001courses/https%3A%2F%2Fg0v.hackmd.io%2F%40jothon%2FB1NIQnmXs' },
        ...
        <Grid container gap='56px' direction='column'>
            ...
            <Grid item container direction='row' justifyContent='space-around' flexWrap='nowrap'>
                { data.map(({ name, url }, index) => (
                        <Grid display='inline-flex' item container key={index} direction='row' alignItems='center' gap='10px'>
